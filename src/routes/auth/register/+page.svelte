...
<svelte:head>
	<title>Registrieren — TaskFuchs</title>
</svelte:head>
	...
	<div class="card w-full max-w-sm bg-base-100 shadow-xl">
		<div class="card-body">
			<div class="text-center mb-4">
				...
				<p class="text-sm text-base-content/60 mt-1">Konto erstellen</p>
			</div>

			{#if success}
				<div class="alert alert-success text-sm">
					<span>Bestätigungsmail gesendet! Bitte prüfe deinen Posteingang.</span>
				</div>
				<p class="text-center text-sm mt-4 text-base-content/60">
					<a href="/auth/login" class="link link-primary">Zurück zum Login</a>
				</p>
			{:else}
				{#if error}
				...
				<button onclick={registerWithGoogle} class="btn btn-outline w-full gap-2" disabled={loading}>
				...
				<p class="text-center text-sm mt-4 text-base-content/60">
					Bereits registriert?
					<a href="/auth/login" class="link link-primary">Anmelden</a>
				</p>
			{/if}
		</div>
	</div>
